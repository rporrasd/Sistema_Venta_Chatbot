...
{
errorMessage+="Nombre de plato vacío!\n";
validationVerified=false;
}
if(foodsForm.price.value=="")
{
errorMessage+="Precio vacío!\n";
validationVerified=false;
}
...
{
errorMessage+="Foto no seleccionada!\n";
validationVerified=false;
}
if(!validationVerified)
{
...
//function to handle cantidadesForm validation
function cantidadesValidate(cantidadesForm){

var validationVerified=true;
var errorMessage="";

if (cantidadesForm.name.value=="")
{
errorMessage+="quantity value not filled!\n";
validationVerified=false;
}
if (cantidadesForm.quantity.selectedIndex==0)
{
...
//function to handle monedaForm validation
function monedaValidate(monedaForm){

var validationVerified=true;
var errorMessage="";

if (monedaForm.name.value=="")
{
errorMessage+="currency/symbol not filled!\n";
validationVerified=false;
}
if (monedaForm.currency.selectedIndex==0)
{
